// ============================================================
// pages/dashboard.js — Halaman Dashboard
// ============================================================

let dashboardDataCache = null;

export async function render(container) {
    await renderDashboardPage(container, true); // true = paksa refresh tiap masuk halaman
}
